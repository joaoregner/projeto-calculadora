...
botaoAlterarTema.addEventListener("click", () => {
    const lightThemeEstaAtivo = body.classList.contains("light-theme")

    body.classList.toggle("light-theme")

    if(lightThemeEstaAtivo) {

        imagemBotaoTrocarDeTema.setAttribute("src", "./src/images/moon.png")
    } else {

        imagemBotaoTrocarDeTema.setAttribute("src", "./src/images/sun.png")
    }
});